 ...
 */
    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".js-mobile-menu") && document.querySelector(".js-close-mobile-menu")) document.addEventListener("click", (function(e) {
        ...
        function formFieldsInit(options = {
            ...
            inputs.forEach((input => {
                if (input.value.length > 0) {
                    ...
                    if (inputClearButton !== null) inputClearButton.classList.add("_active");
                }
            }));
            document.body.addEventListener("input", (function(e) {
                ...
                if (targetElement.tagName === "INPUT" || targetElement.tagName === "TEXTAREA") {
                    ...
                    if (targetElement.closest(".live-search")) {
                        ...
                        if (liveSearchResultLength > 0) liveSearchNode.classList.add("show-result");
                    }
                }
            }));
        ...
        function initSliders() {
            ...
            if (document.querySelector(".mp-makers__slider")) new swiper_core_Swiper(".mp-makers__slider", {
            ...
            if (document.querySelector(".popular-categories__slider")) new swiper_core_Swiper(".popular-categories__slider", {
                modules: [ Navigation, Scrollbar ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
...
***************************************************************************** */
        ...
        document.addEventListener("click", (function(e) {
            if (e.target.closest(".form__clear-svg") || e.target.closest(".js-clear-input")) {
                ...
                let input = line.querySelector(".form__input") || line.querySelector(".form__txt") || line.querySelector(".live-search__input");
        ...
        function sidebarCatalogActions(e) {
            ...
            if (openButton) {
                ...
                if (window.matchMedia("(max-width:991.98px)").matches) bodyLock();
            }
            if (closeButton) {
            ...
            if (backButton) closeSubMenu(activeLink, activeBlock, wrapper);
        ...
        function closeSubMenu(activeLink, activeBlock, wrapper) {
            ...
            if (!activeLink && !activeBlock) return;
